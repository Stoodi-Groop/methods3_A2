...
dummy_df2 <- data.frame(fulldf$types_CHI, fulldf$verbalIQ)
...
#extracting child
bernie <- filter(testdf, ID == 3) #random child
bernie2 <- filter(testdf, ID == 2) #actually bernie
...
bernie2$predicted <- predict(model2, bernie2, allow.new.levels = T)
