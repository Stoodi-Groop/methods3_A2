...
visit1test <- subset(testdf, VISIT == 1, select = c(ID, ADOS, MullenRaw, ExpressiveLangRaw, Socialization))

#renaming the coloumns
 visit1test <- visit1test %>% 
  rename(ADOS1 = ADOS) %>% 
...
#merging the visit 1 values with th dataframe 
testdf <- merge(visit1test, testdf)
