...
#working models
nonandverbal2 <- lmer(CHI_MLU ~ Gender + Age + Diagnosis*VISIT+nonverbalIQ + verbalIQ+I(VISIT^2)+(1+VISIT | ID), fulldf)
...
#new model
onlyverb2 <- lmer(CHI_MLU ~ Gender + Age + VISIT*Diagnosis + I(VISIT^2) + (1 + VISIT | ID), fulldf, REML = F)
...
#new model
onlyverb3 <- lmer(CHI_MLU ~ Gender + Age + VISIT*Diagnosis + I(VISIT^3) + verbalIQ + (1 + VISIT | ID), fulldf, REML = F)
